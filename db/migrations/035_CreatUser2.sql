...
DECLARE
	...
	i INT;
BEGIN
	INSERT INTO users (user_type, name, email, phone_number, address, date_of_birth, password, company_type, country, verified) VALUES (
		_user_type, _name, _email, _phone_number, _address, _date_of_birth, _password, _company_type, _country, _verified
	) RETURNING 
		id, user_type, name, email, phone_number, address, date_of_birth, company_type, null, null, null, null, verified, country
	INTO user_data;
